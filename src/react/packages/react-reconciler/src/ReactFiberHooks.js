...
if (enableUseResourceEffectHook) {
  (HooksDispatcherOnUpdate            ).useResourceEffect =
...
if (enableUseResourceEffectHook) {
  (HooksDispatcherOnRerender            ).useResourceEffect =
    updateResourceEffect;
}
...
if (__DEV__) {
  ...
  if (enableUseResourceEffectHook) {
    (HooksDispatcherOnMountInDEV            ).useResourceEffect =
  ...
  if (enableUseResourceEffectHook) {
    (HooksDispatcherOnMountWithHookTypesInDEV            ).useResourceEffect =
      function useResourceEffect(
        create             ,
        createDeps                            ,
        update                                    ,
  ...
  if (enableUseResourceEffectHook) {
    (HooksDispatcherOnUpdateInDEV            ).useResourceEffect =
      function useResourceEffect(
        create             ,
        createDeps                            ,
        update                                    ,
  ...
  if (enableUseResourceEffectHook) {
    (HooksDispatcherOnRerenderInDEV            ).useResourceEffect =
      function useResourceEffect(
        create             ,
        createDeps                            ,
        update                                    ,
  ...
  if (enableUseResourceEffectHook) {
    (InvalidNestedHooksDispatcherOnMountInDEV            ).useResourceEffect =
      function useResourceEffect(
        create             ,
        createDeps                            ,
        update                                    ,
  ...
  if (enableUseResourceEffectHook) {
    (InvalidNestedHooksDispatcherOnUpdateInDEV            ).useResourceEffect =
      function useResourceEffect(
        create             ,
        createDeps                            ,
        update                                    ,
