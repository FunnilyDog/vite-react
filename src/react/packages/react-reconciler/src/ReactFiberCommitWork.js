...
let viewTransitionCancelableChildren                                          =
...
function restoreEnterViewTransitions(placement       )       {
  if (placement.tag === ViewTransitionComponent) {
    const instance                      = placement.stateNode;
    instance.paired = null;
    restoreViewTransitionOnHostInstances(placement.child, false);
...
function restoreExitViewTransitions(deletion       )       {
  if (deletion.tag === ViewTransitionComponent) {
    const instance                      = deletion.stateNode;
    instance.paired = null;
    restoreViewTransitionOnHostInstances(deletion.child, false);
...
function measureUpdateViewTransition(
  ...
  const updateClassName          = getViewTransitionClassName(
    props.className,
    props.update,
  );
  const layoutClassName          = getViewTransitionClassName(
    props.className,
    props.update,
  );
  let className         ;
