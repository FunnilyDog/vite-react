...
export function attach(
  ...
  function recordResetChildren(
    ...
    while (child !== null) {
      if (child.kind === FILTERED_FIBER_INSTANCE) {
        for (
          let innerChild                          = parentInstance.firstChild;
          innerChild !== null;
  ...
  let initialTreeBaseDurationsMap                                              =
    null;
